  ...
  <div class="player" v-show="playlist.length>0">
    ...
    >
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="tap">
          ...
          <h2 class="subtitle" v-html="currentSong.musicAlbum"></h2>
        </div>
        <div class="middle">
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img :class="cdcls" style="width:40px;height:40px;" :src="currentSong.pic">
        </div>
        <div class="text">
          <h2 class="name" v-html="currentSong.musicName"></h2>
          <p class="desc" v-html="currentSong.musicAlbum"></p>
        </div>
        <div class="control">
    ...
    <audio ref="audio" :src="currentSong.url" @canplay="ready" @error="error" @timeupdate="updataTime"
           @durationchange="durationTime" @ended="end"></audio>
  </div>
</template>
      ...
      .tap {
        ...
        .back {
          ...
          .icon-back:before {
            ...
            height: $imgPlayWidth;
            content: "";
            background: url("../../common/img/dow.svg");
